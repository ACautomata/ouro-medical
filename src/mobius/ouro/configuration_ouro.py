...
class OuroConfig(PretrainedConfig):
    ...
    Args:
        ...
        total_ut_steps (`int`, *optional*, defaults to 4):
            Number of Universal Transformer recurrent steps (loop depth).
    ...
    ```python
    >>> from ouro_looped_lm import OuroConfig

    >>> # Initializing a Ouro style configuration
    >>> configuration = OuroConfig()

    >>> # Initializing a model from the Ouro-1.4B style configuration
    >>> from ouro_looped_lm import OuroModel
